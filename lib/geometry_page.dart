...
class _GeometryPageState extends State<GeometryPage> {
  ...
  Widget build(BuildContext context) {
    ...
    String formulaDescription = GeometryUtility.getFormula(
      widget.geometryType,
    )[1];

    return Scaffold(
      appBar: AppBar(title: Text("$title Geometry")),
        ...
        child: Center(
          child: Column(
            children: <Widget>[
              ...
              Text(
                "Input the required parameters to calculate the volume of the $title.",
                style: const TextStyle(fontSize: 16.0),
                textAlign: TextAlign.center,
              ),
              ...
              ElevatedButton(
                onPressed: () {
                  ...
                  var dialog = AlertDialog(
                    ...
                    content: Text(
                      "The volume of the $title is: ${GeometryUtility.calcVolume(widget.geometryType, input1, input2).toStringAsFixed(2)}",
                    ),
                    actions: [
                      TextButton(
